...
class PersonForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'nationality': TextInput(attrs={"size":"100", "list": "nationality_datalist", "autocomplete":"on" }),
            'marital_status': TextInput(attrs={"size":"100", "list": "marital_status_datalist", "autocomplete":"on" }),
            ...
            'country': TextInput(attrs={"size":"100", "list": "country_datalist", "autocomplete":"on" }),
            'city': TextInput(attrs={"size":"100", "list": "city_datalist", "autocomplete":"on" }),
            'education': TextInput(attrs={"size":"100", "list": "education_datalist", "autocomplete":"on" }),
            'occupation': Textarea(attrs={'cols': 80, 'rows': 3}),            
            'interests': Textarea(attrs={'cols': 80, 'rows': 3}), 
            'eye_color': TextInput(attrs={"size":"100", "list": "eye_color_datalist", "autocomplete":"on" }),
            'hair_color': TextInput(attrs={"size":"100", "list": "hair_color_datalist", "autocomplete":"on" }),
            'body_type': TextInput(attrs={"size":"100", "list": "body_type_datalist", "autocomplete":"on" }),
